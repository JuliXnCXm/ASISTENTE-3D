...
# Subdividir para dar forma
bpy.ops.object.mode_set(mode='EDIT')
bpy.ops.mesh.subdivide(number_cuts=2)
bpy.ops.object.mode_set(mode='OBJECT')

# Modificar vértices para dar forma
for vertex in sofa.data.vertices:
    if vertex.co.z > sofa_height * 0.75:
        vertex.co.z -= 0.05

# Crear material para el sofá
...
bsdf.inputs["Base Color"].default_value = (0.2, 0.2, 0.2, 1)  # Gris oscuro
...
# Crear material para la mesa
table_material = bpy.data.materials.new(name="TableMaterial")
table_material.use_nodes = True
bsdf = table_material.node_tree.nodes["Principled BSDF"]
bsdf.inputs["Base Color"].default_value = (0.5, 0.3, 0.1, 1)  # Madera de nogal
bsdf.inputs["Roughness"].default_value = 0.6
table.data.materials.append(table_material)

# --- Posicionar los objetos ---
# El sofá está en el origen
# La mesa está a 1.5 metros en el eje X
