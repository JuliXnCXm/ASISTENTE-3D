...
material_sofa.diffuse_color = (0.53, 0.53, 0.53, 1)
bpy.context.object.data.materials.append(material_sofa)
...
material_table.diffuse_color = (0.84, 0.52, 0.31, 1)
bpy.context.object.data.materials.append(material_table)

# Posicionar los objetos
sofa.location = (0, -2, 0.1)
